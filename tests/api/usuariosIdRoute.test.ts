...
describe('API /api/usuarios/[id]', () => {
  ...
  getSessionMock().mockResolvedValue(buildSession('7'))
  ...
  getSessionMock().mockResolvedValue(buildSession('3'))
  ...
  getSessionMock().mockResolvedValue(buildSession('15'))
  ...
  getSessionMock().mockResolvedValue(buildSession('33'))
  ...
  getSessionMock().mockResolvedValue(buildSession('44'))
  ...
  getSessionMock().mockResolvedValue(buildSession('18'))
